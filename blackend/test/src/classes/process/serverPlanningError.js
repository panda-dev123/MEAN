...
module.exports = function(app) {
	describe('serverPlanningError', function () {
        ...
        it('System owner not informed! Fetching error!', function (done) {
            InstanceModel.findOne({"name": "server-empty-1"},
                ...
                request(app)
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        InstanceModel.findOne({"name": "server-empty-1"}, function(err, server) {
        ...
        it('Checking history for planned', function (done) {
            request(app)
                ...
                .end(function(err, res) {
                    ...
                    assert.equal(res.body[0].action_tag, "error");
