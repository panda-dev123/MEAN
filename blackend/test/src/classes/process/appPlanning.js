...
module.exports = function(app) {
	describe('appPlanning', function () {
        ...
        it('Setting status to process of app', function (done) {
        ...
        it('Checking server status and attributes', function(done) {
            InstanceModel.find({}, function(err, servers) {
                for (var i = 0; i < servers.length; i++) {
                    assert.equal(servers[i].status, "progress");
                }
        ...
        it('Checking app status and attributes', function(done) {
            InstanceModel.find({}, function(err, servers) {
                for (var i = 0; i < servers.length; i++) {
                    assert.equal(servers[i].applications[0].app_status, "progress");
                }
